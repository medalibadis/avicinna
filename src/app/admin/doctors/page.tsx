          ...
          <div className="bg-white border border-slate-200/90 rounded-[32px] p-6 sm:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto space-y-5 shadow-2xl shadow-slate-900/20 text-slate-900 ring-1 ring-black/5 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-black text-slate-900">
                    {editingDoctor ? 'تعديل بيانات الطبيب' : 'إضافة طبيب استشاري جديد'}
                  </h2>
                  <p className="text-xs text-slate-400">
                    {editingDoctor ? 'تحديث السيرة الذاتية والتخصص والبيانات الطبية' : 'أدخل بيانات الطبيب لعرض ملفه التخصصي للمرضى الدوليين'}
                  </p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <CustomSelect
                    label="التخصص الطبي المرتبط / Specialty *"
                    value={specialtySlug}
