...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-20 overflow-hidden bg-[#0A192F]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#06101E]/95 via-[#0A192F]/90 to-[#0A192F]/85" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        {/* Trust Eyebrow Badge */}
        <div className="inline-flex items-center gap-2 bg-sky-500/15 border border-sky-400/30 backdrop-blur-md px-4 py-1.5 rounded-full mb-6">
          <Sparkles className="w-4 h-4 text-sky-400 animate-spin duration-3000" />
          <span className="text-xs sm:text-sm font-semibold text-sky-200 tracking-wide">
            {eyebrow}
          </span>
        </div>
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.2] mb-6 max-w-4xl mx-auto">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-300 to-sky-400 block sm:inline">
            {headlineHighlight}
          </span>
        </h1>
        ...
        <div className="max-w-2xl mx-auto mb-10">
          ...
          >
            <div className="flex items-center justify-center pl-3 pr-2 text-sky-600">
            ...
            <button
              type="submit"
              className="bg-sky-500 hover:bg-sky-600 text-white font-semibold text-sm px-6 py-3 rounded-xl sm:rounded-full transition-all duration-200 shadow-md shadow-sky-500/30 flex-shrink-0 cursor-pointer"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a
            href="#consultation"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-sky-500 hover:bg-sky-600 text-white font-bold text-base px-8 py-4 rounded-full shadow-lg shadow-sky-500/25 transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
          >
